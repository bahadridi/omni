...
<body>
  ...
  return (
    <div className="flex flex-col h-full bg-gray-900 rounded-lg overflow-hidden">
      {/* Toolbar */}
      <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-ed-green-500/30">
        <div className="flex items-center space-x-2">
          <Code2 className="w-5 h-5 text-ed-green-400" />
          <span className="text-white font-medium">HTML Editor</span>
        </div>
        <div className="flex items-center space-x-4">
          <button
            onClick={handlePreview}
            className="flex items-center space-x-1 px-3 py-1 rounded-md bg-ed-green-500/20 hover:bg-ed-green-500/30 text-ed-green-400"
          >
