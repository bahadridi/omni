...
const SamanthaChat: React.FC<SamanthaChatProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className={`
          bg-gradient-to-br from-ed-bg-secondary/40 via-ed-bg-primary/60 to-ed-green-900/40 border border-ed-green-500/50 shadow-2xl backdrop-blur-xl animate-slidescale
          ${isMobile 
      ...
      >
        ...
        `}>
          ...
          `}>
            <Heart className={`
              text-ed-green-400 animate-pulse drop-shadow-lg
          ...
          {[
            ...
            <div
              ...
              className={`
                ...
                ${isMobile ? 'p-4' : 'p-6'}
                ${chat.type === 'ai' 
                  ? 'bg-gradient-to-br from-ed-green-500/20 via-ed-green-600/15 to-ed-green-700/20 border border-ed-green-500/30' 
            ...
            >
              <div className={`
                ...
                ${chat.type === 'ai' ? 'text-ed-green-400' : 'text-blue-400'}
              `}>
                {chat.sender}:
              </div>
              <div className={`
        ...
        `}>
          <input
            ...
            className={`
                      chat-input bg-black/40 border border-ed-green-500/30 text-white
        placeholder-gray-400 focus:outline-none focus:border-ed-green-400 focus:shadow-lg
        focus:shadow-ed-green-500/20 transition-all duration-300 backdrop-blur-sm
              ${isMobile 
          ...
          />
          <button className={`
            bg-gradient-to-r from-ed-green-500 via-ed-green-600 to-ed-green-700 text-white
                          hover:from-ed-green-600 hover:to-ed-green-800 transition-all duration-300 transform 
