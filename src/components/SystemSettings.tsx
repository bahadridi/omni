  ...
  return (
    <div className={`
      ${isMobile 
        ...
        : 'bg-gray-900/95 backdrop-blur-xl border border-ed-green-500/30 w-full rounded-3xl p-8 max-w-4xl'
      }
    `}>
      {/* Header */}
      <div className={`
        flex items-center justify-between mb-8
        ${isMobile ? 'mb-4 pb-4 border-b border-ed-green-500/20' : 'mb-8'}
      `}>
        <h2 className={`
          font-bold text-white flex items-center gap-3
          ${isMobile ? 'text-xl' : 'text-3xl'}
        `}>
          <Sliders className={`text-ed-green-400 ${isMobile ? 'w-6 h-6' : 'w-8 h-8'}`} />
        ...
        <div className="flex items-center gap-4">
          {!isMobile && (
            <button
              ...
              className="bg-ed-green-500/20 hover:bg-ed-green-500/30 text-ed-green-400 px-4 py-2 rounded-xl
          ...
          <button
            ...
            className={`
              ${isMobile 
                ? 'flex items-center justify-center w-10 h-10 bg-ed-green-500/20 hover:bg-ed-green-500/30 text-ed-green-400 hover:text-ed-green-300 rounded-full border border-ed-green-500/30 transition-all duration-300 active:scale-95'
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`
              ...
              ${activeTab === tab.id
                ? 'bg-ed-green-500/20 text-ed-green-400 border border-ed-green-500/30'
            ...
            {themes.map(t => (
              <div
                ...
                className={`
                  ...
                  ${theme.id === t.id 
                    ? 'border-2 border-ed-green-500 shadow-lg shadow-ed-green-500/20' 
                ...
                >
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${value ? 'bg-ed-green-500' : 'bg-gray-700'}
                    `}
                  >
                    <div
                      className={`
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300">
              ...
              <input
                ...
                className="w-full accent-ed-green-500 bg-gray-700 rounded-lg"
              />
            </div>
            <div className="p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300">
              <div className="flex items-center gap-3 mb-4">
