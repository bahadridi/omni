...
const Documentation: React.FC = () => {
  return (
    <div className="bg-gray-900 rounded-lg p-6 text-white overflow-y-auto max-h-[600px]">
      <h1 className="text-3xl font-bold mb-6 bg-gradient-to-r from-ed-green-400 to-ed-green-600 bg-clip-text text-transparent">
        OmniaOS Documentation
      </h1>

      <div className="space-y-6">
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-ed-green-400">About OmniaOS</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-ed-green-400">AI Companions</h2>
          
          <div className="space-y-4">
            <div className="p-4 bg-ed-green-500/10 rounded-lg border border-ed-green-500/30">
              <h3 className="text-xl font-semibold mb-2 text-ed-green-300">Samantha</h3>
              <p className="text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-ed-green-400">Current Features</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-ed-green-400">Coming Soon - Premium Features</h2>
          <div className="space-y-3">
            <div className="p-3 bg-gradient-to-r from-ed-green-500/10 to-ed-magenta-500/10 rounded-lg border border-ed-green-500/20">
              <h3 className="text-lg font-semibold text-ed-green-300">Enhanced UX & Conversation Screenshots</h3>
            ...
            <div className="p-3 bg-gradient-to-r from-ed-amber-500/10 to-ed-green-500/10 rounded-lg border border-blue-500/20">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-ed-green-400">Getting Started</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-ed-green-400">Privacy & Safety</h2>
          <p className="text-gray-300 leading-relaxed">
      ...
      <div className="mt-8 p-4 bg-gradient-to-r from-ed-green-500/10 to-ed-magenta-500/10 rounded-lg border border-ed-green-500/30">
        <p className="text-center text-ed-green-400">
