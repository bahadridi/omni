    ...
    <div className="flex flex-col h-full min-h-[400px] bg-gray-900 rounded-lg overflow-hidden p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex space-x-2">
          <button 
            className="px-4 py-2 bg-ed-green-500/20 text-ed-green-400 rounded-md hover:bg-ed-green-500/30 transition-colors"
      ...
      <textarea
        ...
        className="flex-1 bg-gray-800 text-white font-mono p-4 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-ed-green-500/50"
        spellCheck="false"
      />
    </div>
  );
