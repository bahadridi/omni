...
const companions = [
  {
    ...
    colors: {
              ...
              accent: 'ed-green-300',
        border: 'ed-green-700/30',
        bg: 'from-ed-green-500/30 to-ed-green-700/30'
    }
  },
  {
    id: 'elias',
    ...
    colors: {
      ...
      accent: 'ed-amber-300',
      border: 'ed-amber-700/30',
      bg: 'from-ed-amber-500/30 to-ed-amber-700/30'
    }
  },
  {
    id: 'lyra',
    ...
    colors: {
      ...
      accent: 'ed-magenta-300',
      border: 'ed-magenta-700/30',
      bg: 'from-ed-magenta-500/30 to-ed-magenta-700/30'
    }
  }
];
...
const AICompanionView: React.FC<AICompanionViewProps> = ({ onClose, initialCompanion }) => {
    ...
    return (
      <div className="fixed inset-0 bg-black/90 backdrop-blur-xl z-[9999] flex items-center justify-center">
        {/* Compact Mobile Modal - Responsive height */}
                  <div className="bg-gradient-to-br from-ed-bg-secondary/95 to-ed-bg-primary/95 rounded-2xl w-full h-screen border border-ed-green-500/30 shadow-2xl backdrop-blur-xl overflow-hidden flex flex-col">
          {/* Mobile Header - Fixed and Always Visible */}
                      <div className="flex items-center justify-between p-3 border-b border-ed-green-500/30 bg-ed-bg-secondary/50 flex-shrink-0 h-14">
            ...
            <button
              onClick={onClose}
                              className="flex items-center justify-center w-8 h-8 bg-ed-green-500/20 hover:bg-ed-green-500/30 text-ed-green-400 hover:text-ed-green-300 rounded-full border border-ed-green-500/30 transition-all duration-300 active:scale-95 z-10"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          <div className="flex-1 p-4 overflow-y-auto">
                  ...
                  <button
                    ...
                    onClick={() => setSelectedCompanion(index)}
                       ...
                       index === selectedCompanion 
                         ? currentCompanion.id === 'samantha' ? 'bg-ed-green-400' : 
                           currentCompanion.id === 'elias' ? 'bg-ed-amber-400' : 'bg-ed-magenta-400'
                         : 'bg-gray-600'
                     }`}
                  />
                ))}
              ...
              {!isVideoLoaded && !videoError && (
                <div className={`absolute inset-0 flex items-center justify-center ${
                  currentCompanion.id === 'samantha' 
                    ? 'bg-gradient-to-br from-ed-green-500/30 to-ed-green-700/30' 
                    : currentCompanion.id === 'elias'
                    ? 'bg-gradient-to-br from-ed-amber-500/30 to-ed-amber-700/30'
                    : 'bg-gradient-to-br from-ed-magenta-500/30 to-ed-magenta-700/30'
                }`}>
            ...
            <div className="text-center">
              <h3 className="text-xl font-bold text-white mb-2">{currentCompanion.name}</h3>
                 ...
                 currentCompanion.id === 'samantha' ? 'text-ed-green-400' : 
                 currentCompanion.id === 'elias' ? 'text-ed-amber-400' : 'text-ed-magenta-400'
                ...
                {currentCompanion.abilities.slice(0, 3).map((ability, index) => (
                  <span
                    key={index}
                       ...
                       currentCompanion.id === 'samantha' 
                         ? 'bg-ed-green-500/20 text-ed-green-400 border-ed-green-500/30'
                         : currentCompanion.id === 'elias'
                ...
                className={`w-full px-4 py-3 text-white font-bold rounded-lg transition-all duration-300 ${
                  !currentCompanion.unlocked 
                    ? 'opacity-50 cursor-not-allowed bg-gray-600' 
                                         : currentCompanion.id === 'samantha'
                       ? 'bg-gradient-to-r from-ed-green-600 to-ed-green-800 hover:from-ed-green-700 hover:to-ed-green-900 active:scale-95'
                       : currentCompanion.id === 'elias'
                       ? 'bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 active:scale-95'
                       : 'bg-gradient-to-r from-ed-magenta-600 to-ed-magenta-800 hover:from-ed-magenta-700 hover:to-ed-magenta-900 active:scale-95'
                }`}
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-xl z-50 flex items-center justify-center p-8">
              <div className="bg-gradient-to-br from-gray-900/90 to-black/90 rounded-3xl p-8 max-w-6xl w-full h-[80vh] border border-ed-green-500/30 shadow-2xl backdrop-blur-xl overflow-hidden">
        {/* Header */}
            ...
            {companions.map((companion, index) => (
              <button
                ...
                className={`px-4 py-2 rounded-full transition-all duration-300 ${
                  index === selectedCompanion 
                                         ? currentCompanion.id === 'samantha'
                       ? 'bg-gradient-to-r from-ed-green-600 to-ed-green-800 text-white'
                       : currentCompanion.id === 'elias'
                       ? 'bg-gradient-to-r from-blue-500 to-cyan-600 text-white'
                       : 'bg-gradient-to-r from-ed-magenta-600 to-ed-magenta-800 text-white'
        ...
        <div className="flex h-[calc(100%-10rem)] gap-6">
          ...
          <div className="w-1/3 space-y-6">
            <div className="bg-gray-800/50 rounded-xl p-6 border border-ed-green-500/20">
              ...
              <button 
                ...
                className={`w-full px-6 py-3 text-white font-bold rounded-xl transition-all duration-300 ${
                  !currentCompanion.unlocked 
                    ? 'opacity-50 cursor-not-allowed bg-gray-600' 
                                         : currentCompanion.id === 'samantha'
                       ? 'bg-gradient-to-r from-ed-green-600 to-ed-green-800 hover:scale-105'
                       : currentCompanion.id === 'elias'
                       ? 'bg-gradient-to-r from-blue-500 to-cyan-600 hover:scale-105'
                       : 'bg-gradient-to-r from-ed-magenta-600 to-ed-magenta-800 hover:scale-105'
                }`}
                disabled={!currentCompanion.unlocked}
              >
                {currentCompanion.unlocked ? 'Explore More' : 'Locked'}
          ...
          {/* Right Panel - Video */}
          <div className="flex-1 bg-gray-900/50 rounded-xl overflow-hidden border border-ed-green-500/20 relative">
            {/* Loading indicator */}
            {!isVideoLoaded && !videoError && currentCompanion.unlocked && (
              <div className="absolute inset-0 flex items-center justify-center">
                                 <div className={`animate-spin rounded-full h-16 w-16 border-b-2 ${
                   currentCompanion.id === 'samantha' ? 'border-ed-green-400' : 
